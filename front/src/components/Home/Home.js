                        ...
                        <div className='w-[90%] h-full flex flex-col justify-evenly m-auto'>
                            ...
                            <div className='bg-quaternary rounded-[40px] h-[250px] shadow-[0_2px_18px_0_rgba(0,0,0,0.5)]'>
                                <div className='h-full flex flex-col'>
                                    ...
                                    <div className='w-[70%] h-[70%] mx-auto flex flex-col justify-evenly'>
                                        <div className='flex flex-row justify-between items-center'><span className='text-white'>Consulter mes notes</span><Link className='w-[38px] h-[38px] bg-white text-quaternary flex justify-center items-center rounded-[10px] relative opacity-80 hover:opacity-100'><i className='fa-duotone fa-file-pen'></i><i class="fa-duotone fa-eye flex justify-center items-center w-[15px] h-[15px] absolute top-[-2px] right-[-2px] bg-quinary rounded-[5px] text-primary text-xs"></i></Link></div>
                                        <div className='flex flex-row justify-between items-center'><span className='text-white'>Consulter mes kanbans</span><Link className='w-[38px] h-[38px] bg-white text-quaternary flex justify-center items-center rounded-[10px] relative opacity-80 hover:opacity-100'><i className='fa-duotone fa-square-kanban'></i><i class="fa-duotone fa-eye flex justify-center items-center w-[15px] h-[15px] absolute top-[-2px] right-[-2px] bg-quinary rounded-[5px] text-primary text-xs"></i></Link></div>
