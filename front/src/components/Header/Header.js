            ...
            {user ? (
                <ul className='flex flex-row'>
                    ...
                    <div className='flex flex-row justify-evenly'>
                        <Link to="/board" className='mr-[10px] no-underline'><i class="fa-duotone fa-list-check text-secondary border border-[#272350] bg-white p-[10px] rounded-[10px] cursor-pointer hover:bg-secondary hover:text-white hover:transition-all"></i></Link>
                        <li onClick={() => logout()} className='mr-[10px] no-underline'><i class="fa-duotone fa-right-from-bracket text-white bg-secondary rounded-[10px] p-[10px] cursor-pointer border border-[#272350] opacity-80 hover:opacity-100 hover:text-white hover:transition-all"></i></li>
                    </div>
                </ul>
